...
# add another facto to identify the comparisons
...
ggsave("Appendix_exp1_robustness_by_markup_revisions.png", width = 16/1.6, height = 12/1.6, units = "in", dpi = 300)
