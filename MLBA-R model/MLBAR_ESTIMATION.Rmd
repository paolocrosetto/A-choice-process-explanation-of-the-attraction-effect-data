...
## regressions for first choices only (this can take quite a while!)
...
## regressions including revisions in choices (this can take quite a while!)
...
## Regressions with revisions in choice and mixed effects (this can take quite a while!)
