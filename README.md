...
| `trust1` to `trust3`        | numeric     | Answers to Dohmen et al. (2008)'s 3 item trust attitude survey, graded higher for higher expressed willingness to trust.                                                                            |
| `soep`                      | numeric     | Answer to the generic SOEP risk taking question (0 to 10 increasing risk tolerance)                                                                                                                 |
...
| `education`                 | categorical | highest dimploma obtained in the French school system                                                                                                                                               |
